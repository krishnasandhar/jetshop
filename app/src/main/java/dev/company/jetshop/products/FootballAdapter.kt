...
class FootballAdapter(
    ...
    var readdata = sqliteDB?.rawQuery("select * from user_footballregister", null)
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        img_update?.setOnClickListener {
            ...
            btn_save?.setOnClickListener {
                ...
                sqliteDB = context.openOrCreateDatabase("footballregister.db", Context.MODE_APPEND,null)
                sqliteDB?.execSQL(" update user_footballregister set productname = '"+edt_productname.text.toString()+"' ,  productprice = '"+edt_price.text.toString()+"',date = '"+edt_date.text.toString()+"' where id ="+product.id+" ")
    ...
    private fun deleteData(id: Int) {
        ...
        builder.setPositiveButton(android.R.string.yes) { dialog, which ->
            sqliteDB?.execSQL("delete from user_footballregister where  id="+id+" ")
            notifyDataSetChanged()
            dialog.dismiss()
            f1.Moving1("Moving1")
        }
