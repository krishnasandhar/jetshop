...
class DanceAdapter(
    ...
    var readdata = sqliteDB?.rawQuery("select * from user_danceregister", null)
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        img_update?.setOnClickListener {
            ...
            btn_save?.setOnClickListener {
                ...
                sqliteDB = context.openOrCreateDatabase("danceregister.db", Context.MODE_APPEND,null)
                sqliteDB?.execSQL(" update user_danceregister set productname = '"+edt_productname.text.toString()+"' ,  productprice = '"+edt_price.text.toString()+"',date = '"+edt_date.text.toString()+"' where id ="+product.id+" ")
    ...
    private fun deleteData(id: Int) {
        ...
        builder.setPositiveButton(android.R.string.yes) { dialog, which ->
            sqliteDB?.execSQL("delete from user_danceregister where  id="+id+" ")
            notifyDataSetChanged()
            dialog.dismiss()
            d1.Moving2("Moving2")
        }
