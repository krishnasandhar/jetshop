...
class CricketActivity : AppCompatActivity(), CricketAdapter.carr, CricketAdapter.carr1 {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val TABLE_CREATE =
            "create table if not exists user_cricketregister( id integer PRIMARY KEY AUTOINCREMENT,productname varchar(20),productprice varchar(15),date varchar(20))"
    ...
    override fun onResume() {
        ...
        val adapter = CricketAdapter(this@CricketActivity,productsdetail,layoutInflater,this,this)
        cricketlist?.adapter = adapter
        adapter.notifyDataSetChanged()
    }
    private fun showAlerts() {

        val builder = AlertDialog.Builder(this@CricketActivity).create()
        ...
        btn_save.setOnClickListener {
            ...
            if (productname.length==0) {
                ...
                sqliteDB?.execSQL("insert into user_cricketregister(productname,productprice,date) values('"+ productname+"','"+ price+"','"+date+"')")
                builder.dismiss()
                onResume()
            }
        }
