...
class FootballActivity : AppCompatActivity(), FootballAdapter.foot, FootballAdapter.foot1 {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val TABLE_CREATE =
            "create table if not exists user_footballregister( id integer PRIMARY KEY AUTOINCREMENT,productname varchar(20),productprice varchar(15),date varchar(20))"
    ...
    override fun onResume() {
        ...
        val adapter = FootballAdapter(this@FootballActivity,productsdetail,layoutInflater,this,this)
        footballlist?.adapter = adapter
        adapter.notifyDataSetChanged()
    }
    private fun showAlerts() {

        val builder = AlertDialog.Builder(this@FootballActivity).create()
        ...
        btn_save.setOnClickListener {
            ...
            if (productname.length==0) {
                ...
                sqliteDB?.execSQL("insert into user_footballregister(productname,productprice,date) values('"+ productname+"','"+ price+"','"+date+"')")
                builder.dismiss()
                onResume()
            }
        }
