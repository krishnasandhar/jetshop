...
class DartsActivity : AppCompatActivity(), DartsAdapter.dart, DartsAdapter.dart1 {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val TABLE_CREATE =
            "create table if not exists user_dartsregister( id integer PRIMARY KEY AUTOINCREMENT,productname varchar(20),productprice varchar(15),date varchar(20))"
    ...
    override fun onResume() {
        ...
        val adapter = DartsAdapter(this@DartsActivity,productsdetail,layoutInflater,this,this)
        dartslist?.adapter = adapter
        adapter.notifyDataSetChanged()
    }
    private fun showAlerts() {

        val builder = AlertDialog.Builder(this@DartsActivity).create()
        ...
        btn_save.setOnClickListener {
            ...
            if (productname.length==0) {
                ...
                sqliteDB?.execSQL("insert into user_dartsregister(productname,productprice,date) values('"+ productname+"','"+ price+"','"+date+"')")
                builder.dismiss()
                onResume()
            }
        }
