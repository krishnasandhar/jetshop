...
class ArcheryActivity: AppCompatActivity(), ArcheryAdapter.testingInt, ArcheryAdapter.testingInt2 {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val TABLE_CREATE =
            "create table if not exists user_archeryproducts( id integer PRIMARY KEY AUTOINCREMENT,productname varchar(20),productprice varchar(15),date varchar(20),avatar varchar(40))"
    ...
    override fun onResume() {
        ...
        val adapter = ArcheryAdapter(this@ArcheryActivity,productsdetail,layoutInflater,this,this)
        archerylist?.adapter = adapter
        adapter.notifyDataSetChanged()
    }
    private fun showAlerts() {

        val builder = AlertDialog.Builder(this@ArcheryActivity).create()
        ...
        btn_save.setOnClickListener {
            ...
            if (productname.length==0) {
                ...
                sqliteDB?.execSQL("insert into user_archeryproducts(productname,productprice,date) values('"+ productname+"','"+ price+"','"+date+"')")
                builder.dismiss()
                onResume()
            }
        }
