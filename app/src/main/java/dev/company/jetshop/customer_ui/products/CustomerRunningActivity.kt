...
class CustomerRunningActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_customer_running)
        ...
        val adapter = CustomerRunningAdapter(this@CustomerRunningActivity, productsdetail,layoutInflater)
